...
- [ ] **AI-07 · Fisher-Yates shuffle** — El barajado actual (`sort(() => Math.random() - 0.5)`) es estadísticamente sesgado. Reemplazar por Fisher-Yates. Sin riesgo, afecta a todos los niveles.
...
- [ ] **AI-09 · Memoria del descarte por nivel** — Pasar a la evaluación solo la parte del descarte rival que cada nivel "recuerda" (ninguna / última / últimas 3 / todo). Palanca principal de diferenciación entre niveles.
...
- [ ] **AI-05 · Niveles 4-5 · Detección de amenaza en 2 turnos** — Reconocer que el jugador está a 2 cartas de compilar una línea y marcarla como urgente.
